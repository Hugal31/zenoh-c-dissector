...
#define zh_push_body_names_VALUE_STRING_LIST(V) \
 ...
 _U_ VALUE_STRING_ARRAY(zh_push_body_names);
...
static hf_register_info hf[] = {
        {&hf_zenoh_transport_msg_type,
         {"Transport message type",
          "zenohc.transport.type",
          FT_UINT8,
          BASE_DEC,
          VALS(zh_transport_msg_type_names),
          0x1F,
          NULL,
          HFILL}},
        ...
        {&hf_ext_unit, {"Unit Ext", "zenohc.ext", FT_NONE, BASE_NONE, NULL, 0, NULL, HFILL}},
        {&hf_ext_z64, {"Z64 Ext", "zenohc.ext.z64", FT_UINT64, BASE_DEC, NULL, 0, NULL, HFILL}},
        {&hf_ext_zbuf, {"ZBuf Ext", "zenohc.ext.zbuf", FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL}},
        ...
        {&hf_key_expr_suffix,
         {"Key Expr suffix", "zenohc.key_expr.suffix", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL}},
        ...
        {&hf_consolidation,
         {"Consolidation",
          "zenohc.query.consolidation",
          FT_UINT8,
          BASE_DEC,
          VALS(zh_consolidation_names),
          0,
          NULL,
          HFILL}},
        ...
        {&hf_linkstate_wai,
         {"What Am I", "zenohc.linkstate.wai", FT_UINT8, BASE_DEC, VALS(zh_what_am_i_flags_names), 0, NULL, HFILL}},
        ...
        {&hf_rmw_zenoh_sequence_number,
         {"Sequence number", "zenohc.rmw_zenoh.sn", FT_UINT64, BASE_DEC, NULL, 0, NULL, HFILL}},
        {&hf_rmw_zenoh_timestamp,
         {"Timestamp", "zenohc.rmw_zenoh.timestamp", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0, NULL, HFILL}},
        {&hf_rmw_zenoh_source_gid,
         {"Source GID", "zenohc.rmw_zenoh.source_gid", FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL}},
        {&hf_reply_to_query,
         {"Reply in",
          "zenohc.query.reply_frame",
          FT_FRAMENUM,
          BASE_NONE,
        ...
        {&hf_close_reason,
         {"Close reason", "zenohc.close.reason", FT_UINT8, BASE_DEC, VALS(zh_close_reasons_names), 0, NULL, HFILL}},
        {&hf_interest_mode,
         {"Interest mode",
        ...
        {&hf_interest_keyexprs,
         {"Key expressions", "zenohc.interest.keyexprs", FT_BOOLEAN, 8, NULL, (1 << 0), NULL, HFILL}},
        {&hf_interest_subscribers,
         {"Subscribers", "zenohc.interest.subscribers", FT_BOOLEAN, 8, NULL, (1 << 1), NULL, HFILL}},
        {&hf_interest_queryables,
         {"Queryable", "zenohc.interest.queryables", FT_BOOLEAN, 8, NULL, (1 << 2), NULL, HFILL}},
        {&hf_interest_tokens, {"Tokens", "zenohc.interest.tokens", FT_BOOLEAN, 8, NULL, (1 << 3), NULL, HFILL}},
...
static struct ext_dissector_table_entry put_exts[] = {
        {3, "Attachements", &dissect_attachment},
        {0},
};

static int dissect_put(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
    ...
    if (has_encoding)
    {
        ...
        proto_tree *schema_tree =
                proto_tree_add_subtree(tree, tvb, start, offset - start, ett_zenoh, &schema_item, "Schema ");
...
static int dissect_response_body(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
...
static int dissect_push(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
    ...
    offset = dissect_key_expr(tvb, pinfo, tree, offset + 1, has_suffix, mapping, NULL);
...
static struct ext_dissector_table_entry query_exts[] = {
        {5, "Attachements", &dissect_attachment},
        {0},
};

static int dissect_query(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
...
static int dissect_request(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
    const bool has_suffix = (msg_header & 0x20) != 0;
    const bool mapping = (msg_header & 0x40) != 0;
    ...
    offset = dissect_key_expr(tvb, pinfo, tree, offset, has_suffix, mapping, NULL);
...
static int dissect_reply(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
    const bool has_consolidation = (msg_header & 0x20) != 0;
    const bool has_exts = (msg_header & 0x80) != 0;
...
static int dissect_response(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
    const bool has_suffix = (msg_header & 0x20) != 0;
    const bool mapping = (msg_header & 0x40) != 0;
...
static int dissect_net_oam(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    ...
    switch (encoding)
    {
        default:
        case 0: break;
        case 0b01: offset = dissect_zint(tvb, tree, offset, hf_net_oam_data, NULL, NULL); break;

        case 0b10:
        {
            int payload_length = (int)read_zint(tvb, &offset);
            proto_item *payload_item =
                    proto_tree_add_item(tree, hf_net_oam_payload, tvb, offset, payload_length, ENC_NA);
            if (id == 1)
...
static int dissect_net_message(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, offset);
...
static int dissect_transport_frame(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
...
static int dissect_transport_fragment(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
...
static int dissect_transport_close(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
...
static void
dissect_open_compression(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, int length, void *data)
{
...
static struct ext_dissector_table_entry transport_open_exts[] = {
        {4, "Multilink"},
        {6, "Compression", &dissect_open_compression},
        {0, NULL},
};

static int dissect_transport_open(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, 0);
...
static void
dissect_init_compression(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, int offset, int length, void *data)
{
    proto_tree_add_item(tree, hf_ext_compression, tvb, offset, 1, ENC_NA);
...
static struct ext_dissector_table_entry transport_init_exts[] = {
        {1, "QosExt", &dissect_qos_ext},
        {4, "Multilink"},
        {6, "Compression", &dissect_init_compression},
        {7, "Patch"},
        {0},
};

static int dissect_transport_init(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
    const uint8_t msg_header = tvb_get_uint8(tvb, 0);
    const bool is_ack = (msg_header & 0x20) != 0;
...
static int dissect_transport_msg(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
    ...
    switch (msg_type)
    {
        case ZENOH_TRANSPORT_INIT: return dissect_transport_init(tvb, pinfo, proto_tree, data);
        case ZENOH_TRANSPORT_OPEN: return dissect_transport_open(tvb, pinfo, proto_tree, data);
        case ZENOH_TRANSPORT_FRAME: return dissect_transport_frame(tvb, pinfo, proto_tree, data);
        case ZENOH_TRANSPORT_KEEP_ALIVE: return dissect_transport_keep_alive(tvb, pinfo, proto_tree, data);
        case ZENOH_TRANSPORT_FRAGMENT: return dissect_transport_fragment(tvb, pinfo, proto_tree, data);
        case ZENOH_TRANSPORT_CLOSE: return dissect_transport_close(tvb, pinfo, proto_tree, data);
        default: return (int)tvb_reported_length(tvb);
    }
}
...
static int dissect_zenoh_pdu_stream(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
...
static int dissect_zenoh(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
