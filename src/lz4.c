...
tvbuff_t *
zenoh_tvb_uncompress_lz4(tvbuff_t *tvb, const int offset, int comprlen) {
  ...
  while (decoded == output_size) {
    ...
    decoded = LZ4_decompress_safe_continue(decoder, NULL, output + total_decompressed, 0, output_size - total_decompressed);
...
tvbuff_t *
zenoh_tvb_child_uncompress_lz4(tvbuff_t *parent, tvbuff_t *tvb, const int offset, int comprlen) {
